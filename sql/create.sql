...
create table players (
    ...
    name varchar(200),
    field_position_id int references field_position,
    club varchar(100)
);

-- GRANTS
grant all privileges on players to scraper;
grant select on team to scraper;
grant select on field_position to scraper;
grant usage, select on sequence players_id_seq to scraper;
